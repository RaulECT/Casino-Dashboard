...
var Panel = function (_Component) {
  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      var styles = _extends({
        background: 'rgba(0, 0, 0, ' + (this.props.opacity ? this.props.opacity : 0) + ')',
        display: 'grid',
        gridTemplateColumns: this.props.gridTemplateColumns,
        gridTemplateRows: this.props.gridTemplateRows,
        rowGap: this.props.rowGap ? this.props.rowGap : 0,
        columnGap: this.props.columnGap ? this.props.columnGap : 0
      }, this.props.style);
