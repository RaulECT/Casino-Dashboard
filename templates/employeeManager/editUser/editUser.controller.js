...
(function () {
  ...
  edituserctrl.$inject = ['$location', '$mdDialog', '$scope', 'fingerFactory', 'employeeFactory', 'roleFactory', '$scope'];

  function edituserctrl($location, $mdDialog, $scope, fingerFactory, employeeFactory, roleFactory, $scope) {
    ...
    function getUser(){
      vm.user = employeeFactory.getUser();
      console.log(vm.user);
